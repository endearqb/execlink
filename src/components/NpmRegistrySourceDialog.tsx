...
interface NpmRegistrySourceDialogProps {
  open: boolean;
  title: string;
...
export function NpmRegistrySourceDialog({
  open,
  title,
  officialCommand,
  mirrorCommand,
    ...
    <div className="fixed inset-0 z-[2100] flex items-center justify-center p-4">
      ...
      >
        ...
        <p className="mt-2 text-xs leading-[1.5] text-[var(--ui-muted)]">
          请选择 npm 源。镜像源将追加 <code>--registry=https://registry.npmmirror.com</code>。
        </p>
        <div className="mt-2 grid gap-2">
          <div className="rounded-[var(--radius-md)] border border-[#ddd5c9] bg-[var(--ui-base)] p-2 shadow-[inset_2px_2px_4px_#d5d0c4,inset_-2px_-2px_4px_#ffffff]">
            ...
            <pre className="mt-1 text-[11px] leading-[1.45] text-[var(--ui-muted)]">{officialCommand}</pre>
          </div>
          <div className="rounded-[var(--radius-md)] border border-[#ddd5c9] bg-[var(--ui-base)] p-2 shadow-[inset_2px_2px_4px_#d5d0c4,inset_-2px_-2px_4px_#ffffff]">
            <p className="m-0 text-xs font-semibold text-[var(--ui-text)]">npm 镜像源（npmmirror）</p>
            <pre className="mt-1 text-[11px] leading-[1.45] text-[var(--ui-muted)]">{mirrorCommand}</pre>
          </div>
        </div>
